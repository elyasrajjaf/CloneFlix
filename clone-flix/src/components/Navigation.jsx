...
export const Navigation = () => {
  return (
      <div className="w-full h-screen px-5 py-20 bg-gray-800 sticky top-0">
        <div class="max-h-screen flex items-center justify-center bg-slate-800 py-20 ">
            ...
            <ul class="flex flex-col w-full">
              <li class="my-px">
                ...
                >
                  ...
                  <span class="flex items-center justify-center text-sm text-gray-500 font-semibold bg-gray-300 h-6 px-2 rounded-full ml-auto">
                    3
                  </span>
                </a>
              </li>
              <li class="my-px">
                <a
                  href="#"
                  class="flex flex-row items-center h-12 px-3 rounded-lg text-gray-500 hover:bg-gray-700"
                >
                  <span class="flex items-center justify-center text-lg text-gray-500">
                    <svg
                      fill="none"
                  ...
                  <span class="ml-4 flex font-medium text-m text-gray-400 uppercase">
              ...
              <li class="my-px">
                ...
                >
                  <span class="flex items-center mt-2 justify-center text-lg text-gray-500">
                    <svg
                      fill="none"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                  ...
                  <span class="ml-3 flex font-medium text-m text-gray-400 uppercase">
              ...
              <li class="my-px">
                <a
                  ...
                  class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-500 hover:bg-gray-700"
                >
                  <span class="flex items-center justify-center text-lg text-gray-500 mt-2">
                    <svg
                      fill="none"
                      stroke-linecap="round"
                      stroke-linejoin="round"
